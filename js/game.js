...
const Character = (function character() {
  ...
  roles.penitent = { suns: 4, leaves: 4, waves: 6, int: 8, wil: 8, chr: 6 };
  // The Consul is a figher .
  roles.consul = { suns: 8, leaves: 6, waves: 4, int: 6, wil: 6, chr: 6 };
  // The Light Keeper is a rogue .
  roles['light keeper'] = { suns: 6, leaves: 8, waves: 8, int: 6, wil: 4, chr: 4 };
  // The Painter is a wizard .
  roles.painter = { suns: 6, leaves: 4, waves: 6, int: 8, wil: 8, chr: 4 };
  // The Savage is a barbarian .
  roles.savage = { suns: 8, leaves: 8, waves: 4, int: 6, wil: 4, chr: 6 };
  // THe Lunatic is a druid .
  roles.lunatic = { suns: 4, leaves: 1, waves: 4, int: 9, wil: 9, chr: 9 };
  // The Author is a monk.
  roles.author = { suns: 4, leaves: 9, waves: 8, int: 5, wil: 9, chr: 1 };
  // The Watchman is a paladin.
  roles.watchman = { suns: 6, leaves: 6, waves: 4, int: 4, wil: 8, chr: 8 };
  // The Huntress is a ranger.
  roles.huntress = { suns: 6, leaves: 6, waves: 8, int: 6, wil: 6, chr: 4 };
  // The Merchant is a sorcerer.
  roles.merchant = { suns: 4, leaves: 2, waves: 5, int: 9, wil: 8, chr: 8 };
  // The Bard is a bard.
  roles.bard = { suns: 5, leaves: 4, waves: 6, int: 8, wil: 5, chr: 8 };
...
const Renderer = (function renderer() {
  ...
  function renderRole() {
    ...
    ['suns', 'leaves', 'waves', 'int', 'wil', 'chr'].forEach((attr) => {
      let html = '';
